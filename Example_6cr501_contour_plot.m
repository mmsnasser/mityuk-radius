...
% will be loaded in this file to plot Figure 16 (second row, left)
% in the paper:
...
etp(1+(k-1)*n:k*n,1) =      -0.2i.*exp(-i.*t);
%
x=load('x5cr_501_pt.mat','-ascii');
y=load('y5cr_501_pt.mat','-ascii');
R=load('R5cr_501_pt.mat','-ascii');
%%
R(abs(x+i*y-0.6i)<0.209)=NaN;
R(abs(x+i*y+0.6i)<0.209)=NaN;

tv=[0.1,0.22,0.4,0.46,0.6,0.8,1.8];
tvr=[0.1704,0.2945];
figure
hold on
box on
...
print(gcf,'-depsc2','fig_5cir501.eps')
%