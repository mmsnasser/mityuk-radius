...
% will be loaded in this file to plot Figure 5 (second row, right)
% in the paper:
...
x0=load('s2cr5_0_pt.mat','-ascii');
R0=load('Rs2cr5_0_pt.mat','-ascii');
% loading the data files for the canonical domain: 
% the unit disk with a circular slit
x5=load('s2cr5_5_pt.mat','-ascii');
R5=load('Rs2cr5_5_pt.mat','-ascii');
%
%
% Plot the figure
figure
...
% axis equal
% axis off
% print -depsc fig_2cr_allL
% print -dpdf  fig_2cr_allL
%