...
%
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% This collection of files contains the following files which used to plot
% the figures in the paper:
% 
% El Mostafa Kalmoun, Mohamed M S Nasser, and Matti Vuorinen, Numerical 
% computation of Mityuk’s function and radius for circular/radial slit
% domains.
% 
% The data generated by the files in the subfolder: generating data.rar
% The data is in the subfolder: data.rar
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% 
% 
% 
