...
x=load('x2cr5_0_pt.mat','-ascii');
y=load('y2cr5_0_pt.mat','-ascii');
R=load('R2cr5_0_pt.mat','-ascii');
% plot the contour lines
tv  = [0.12,0.24,0.36,0.48,0.6,0.72,0.85,1,1.25,2]; %level values
tvr  = [0.38576,1.0133]; %level values
figure
hold on
box on
...
axis equal
% axis off
% print -depsc fig_2cr_0R
% print -dpdf  fig_2cr_0R
%%