...
% will be loaded in this file to plot Figure 14 (left)
% in the paper:
...
etp(1+(k-1)*n:k*n,1) =     -1i.*exp(-i.*t);
%
x=load('x3cr_55_pt.mat','-ascii');
y=load('y3cr_55_pt.mat','-ascii');
R=load('R3cr_55_pt.mat','-ascii');
%%
tv  = [0.2,0.55,0.8,1.25,1.45,1.6,1.675]; %level values
tvr  = [0.3855,1.0134]; %level values
figure
hold on
box on
...
print(gcf,'-depsc2','fig_3cir55.eps')
%