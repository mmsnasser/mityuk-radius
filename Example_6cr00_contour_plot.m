...
% will be loaded in this file to plot Figure 16 (first row, right)
% in the paper:
...
etp(1+(k-1)*n:k*n,1) =      -0.2i.*exp(-i.*t);
%
x=load('x5cr_00_pt.mat','-ascii');
y=load('y5cr_00_pt.mat','-ascii');
R=load('R5cr_00_pt.mat','-ascii');
%%
tv=[0.05,0.16,0.3,0.5,0.8,1.3,2,3,7];
tvr=[4.704,4.704];
figure
hold on
box on
...
print(gcf,'-depsc2','fig_5cir00.eps')
%