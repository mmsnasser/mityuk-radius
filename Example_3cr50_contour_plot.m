...
% will be loaded in this file to plot Figure 14 (right)
% in the paper:
...
etp(1+(k-1)*n:k*n,1) =     -1i.*exp(-i.*t);
%
x=load('x3cr_50_pt.mat','-ascii');
y=load('y3cr_50_pt.mat','-ascii');
R=load('R3cr_50_pt.mat','-ascii');
%%
% R(abs(x+i*y-0.6i)<0.209)=NaN;
% R(abs(x+i*y+0.6i)<0.209)=NaN;
tv  = [0.19,0.6,0.85,1.2,1.7,2.5,4,8]; %level values
tvr = [0.388 0.388]; %level values
figure
hold on
box on
...
print(gcf,'-depsc2','fig_3cir50.eps')
%