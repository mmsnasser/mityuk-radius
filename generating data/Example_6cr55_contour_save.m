...
% to plot the contour lines in Figure 16 (first row, left) in the paper:
...
% here theta_1=theta_2=theta_3=theta_4=theta_5=pi/2 (the canonical 
% domain is the unit disk with 5 circular slits
%
thetak = [pi/2;pi/2;pi/2;pi/2;pi/2;pi/2];
...
% save the data
save('x5cr_55_pt.mat', 'x', '-ascii', '-double')
save('y5cr_55_pt.mat', 'y', '-ascii', '-double')
save('R5cr_55_pt.mat', 'R', '-ascii', '-double')
%