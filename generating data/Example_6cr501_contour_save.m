% Example_6cr501_contour_save.m
% Nasser June 12, 2019
clear;clc
% To generate the data in the files:
% x5cr_501_pt.mat, y5cr_501_pt.mat, R5cr_501_pt.mat,
% which will be used by the MATLAB file:
% Example_6cr501_contour_plot.m
% to plot the contour lines in Figure 16 (second row, left) in the paper:
...
% here theta_1=theta_2=theta_3=theta_5=pi/2, theta_4=0 (the canonical 
% domain is the unit disk with 1 radial slit and 4 circular slits
%
thetak = [pi/2;pi/2;pi/2;pi/2;0;pi/2];
...
% save the data
save('x5cr_501_pt.mat', 'x', '-ascii', '-double')
save('y5cr_501_pt.mat', 'y', '-ascii', '-double')
save('R5cr_501_pt.mat', 'R', '-ascii', '-double')
%