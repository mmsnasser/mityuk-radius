...
% to plot Figure 10 (left) in the paper:
...
%%
save('s5v_pt.mat',  's', '-ascii', '-double')
save('R5v1_pt.mat', 'R1', '-ascii', '-double')
save('R5v2_pt.mat', 'R2', '-ascii', '-double')
save('R5v3_pt.mat', 'R3', '-ascii', '-double')
save('R5v4_pt.mat', 'R4', '-ascii', '-double')
%%
figure
hold on
box on
plot(s,R4,'--m','LineWidth',1.2)
plot(s,R3,':b','LineWidth',1.2)
plot(s,R2,'--k','LineWidth',1.2)
plot(s,R1,'r','LineWidth',1.2)
axis([-1 1 0 2.5])
% axis equal
%%