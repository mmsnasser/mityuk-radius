...
%
%
save('s_tri_5_pt.mat',  's', '-ascii', '-double')
save('Rs_tri_v_51_pt.mat', 'Rv1', '-ascii', '-double')
save('Rs_tri_v_52_pt.mat', 'Rv2', '-ascii', '-double')
save('Rs_tri_h_51_pt.mat', 'Rh1', '-ascii', '-double')
save('Rs_tri_h_52_pt.mat', 'Rh2', '-ascii', '-double')
%