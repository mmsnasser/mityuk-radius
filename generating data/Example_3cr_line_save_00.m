...
% to plot Figure 15 (center) in the paper:
...
% here theta_1=theta_2=0 (the canonical domain is the unit disk with 
% two radial slits
%
thetak = [pi/2;0;0];
...
% 
% save the data
save('s3cr_00_pt.mat', 's', '-ascii', '-double')
save('Rs3cr_00_pt.mat', 'R', '-ascii', '-double')
%