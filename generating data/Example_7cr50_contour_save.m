...
% to plot the contour lines in Figure 17 (right) in the paper:
...
% here theta_1=theta_2=theta_3=pi/2, theta_4=theta_5=theta_6=0 
% (the canonical domain is the unit disk with 3 circular slits and radial
% slits
%
...
% save the data
save('x7cr_50_pt.mat', 'x', '-ascii', '-double')
save('y7cr_50_pt.mat', 'y', '-ascii', '-double')
save('R7cr_50_pt.mat', 'R', '-ascii', '-double')
%