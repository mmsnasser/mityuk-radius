...
[r,theta]=meshgrid([linspace(0.251,1.049,70)],[linspace(0,2*pi,101)]);
x=0.05+r.*cos(theta);
y=r.*sin(theta);
z=x+i*y;
z(abs(z)>=1)     = NaN;
...
% save the data
save('x2cr05_0_pt.mat', 'x', '-ascii', '-double')
save('y2cr05_0_pt.mat', 'y', '-ascii', '-double')
save('R2cr05_0_pt.mat', 'R', '-ascii', '-double')
%