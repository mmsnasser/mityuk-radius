...
% here theta_1=theta_2=pi/2 (the canonical 
% domain is the unit disk with 2 circular slits
%
thetak = [pi/2;pi/2;pi/2];
...
[x,y]=meshgrid([-2.98:0.05:-2.78,-2.74:0.02:-1.5,-1.46:0.05:-0.01,0,0.01:0.05:1.46,1.5:0.02:2.74,2.78:0.05:2.98],...
...
% save the data
save('x3cr_55_pt.mat', 'x', '-ascii', '-double')
save('y3cr_55_pt.mat', 'y', '-ascii', '-double')
save('R3cr_55_pt.mat', 'R', '-ascii', '-double')
%