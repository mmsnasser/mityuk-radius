...
%
%
[x,y]=meshgrid([0.05:0.05:2.75,2.8:0.02:4.2,4.25:0.05:4.95],...
               [0.05:0.05:0.55,0.6:0.02:3.2,3.25:0.05:4.95]);
z=x+i*y;
...
%
save('xtritri5_pt.mat', 'x', '-ascii', '-double')
save('ytritri5_pt.mat', 'y', '-ascii', '-double')
save('Rtritri5_pt.mat', 'R', '-ascii', '-double')
%