...
% to plot Figure 12 (right) in the paper:
...
%
%
s   = [-2.999,-2.998:0.004:-0.002,-0.001,0.001,0.002:0.004:0.998,1.001,1.002:0.004:2.998,2.999];
z1  =  s;        z1(s>=0 & s<=1.0)=NaN;
z2  =  s+0.25i;  z2(s>=0 & s<=1.0)=NaN;
z3  =  s+0.5i;   z3(s>=0 & s<=1.0)=NaN;
sum(sum(abs(s)>=0))
%
figure
hold on
...
%
save('s_rr_h_0_pt.mat',  's', '-ascii', '-double')
save('Rs_rr_h_0_1_pt.mat', 'R1', '-ascii', '-double')
save('Rs_rr_h_0_2_pt.mat', 'R2', '-ascii', '-double')
save('Rs_rr_h_0_3_pt.mat', 'R3', '-ascii', '-double')
%
