...
% here theta_1=pi/2, theta_2=0 (the canonical 
% domain is the unit disk with a circular slit and a radial slit
%
thetak = [pi/2;pi/2;0];
...
[x,y]=meshgrid([-2.98:0.05:-2.63,-2.6:0.02:-1.5,-1.46:0.05:-0.01,0,0.01:0.05:1.46,1.5:0.02:2.74,2.78:0.05:2.98],...
...
% save the data
save('x3cr_50_pt.mat', 'x', '-ascii', '-double')
save('y3cr_50_pt.mat', 'y', '-ascii', '-double')
save('R3cr_50_pt.mat', 'R', '-ascii', '-double')
%