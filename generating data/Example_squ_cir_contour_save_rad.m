...
% to plot the contour lines in Figure 13 (second row, right) in the paper:
...
%%
save('xsqucir0_pt.mat', 'x', '-ascii', '-double')
save('ysqucir0_pt.mat', 'y', '-ascii', '-double')
save('Rsqucir0_pt.mat', 'R', '-ascii', '-double')
%