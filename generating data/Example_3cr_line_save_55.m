...
% to plot Figure 15 (left) in the paper:
...
% here theta_1=theta_2=pi/2 (the canonical domain is the unit disk with 
% two circular slits
%
...
% 
% save the data
save('s3cr_55_pt.mat', 's', '-ascii', '-double')
save('Rs3cr_55_pt.mat', 'R', '-ascii', '-double')
%