...
% to plot Figure 12 (left) in the paper:
...
%
%
save('s_rr_v_5_pt.mat',  's', '-ascii', '-double')
save('Rs_rr_v_5_1_pt.mat', 'R1', '-ascii', '-double')
save('Rs_rr_v_5_2_pt.mat', 'R2', '-ascii', '-double')
save('Rs_rr_v_5_3_pt.mat', 'R3', '-ascii', '-double')
save('Rs_rr_v_5_4_pt.mat', 'R4', '-ascii', '-double')
%