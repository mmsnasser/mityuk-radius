...
%
%
[x,y]=meshgrid([-2.99:0.04:-0.07,-0.04:0.02:1.04,1.07:0.04:2.99],...
               [-0.99:0.04:-0.43,-0.41:0.02:0.73,0.75:0.04:0.99]);
z=x+i*y;
...
%%
save('xrecrec5_pt.mat', 'x', '-ascii', '-double')
save('yrecrec5_pt.mat', 'y', '-ascii', '-double')
save('Rrecrec5_pt.mat', 'R', '-ascii', '-double')
%