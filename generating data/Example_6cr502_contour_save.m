...
% to plot the contour lines in Figure 16 (second row, right) in the paper:
...
% here theta_1=theta_2=theta_3=theta_5=0, theta_4=pi/2 (the canonical 
% domain is the unit disk with 4 radial slits and one circular slit
%
thetak = [pi/2;0;0;0;pi/2;0];
...
% save the data
save('x5cr_502_pt.mat', 'x', '-ascii', '-double')
save('y5cr_502_pt.mat', 'y', '-ascii', '-double')
save('R5cr_502_pt.mat', 'R', '-ascii', '-double')
%